...
function comment_form_edit($xpent){
  $xpent['author'] = '<div class=" mb-30"><input name="author" required="" id="name" placeholder="Your name" class="form-control" type="text" ></div>';
  $xpent['email'] ='<div class=" mb-30"><input name="email" required="" id="email" placeholder="Email" class="form-control" type="text" ></div>';
  $xpent['url'] = '<div class=" mb-30"><input name="url" class="form-control" type="text" placeholder="Website" /></div>';
  $xpent['comment_field'] ='<div class=" mb-30"><textarea cols="30" rows="3" name="comment"  placeholder="Message" required="required"  id="message" placeholder="Your message here" rows="6" class="form-control" ></textarea></div>';
  return $xpent;
}
// second  stape 
